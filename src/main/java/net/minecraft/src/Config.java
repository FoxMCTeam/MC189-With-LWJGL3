    ...
    public static void checkDisplaySettings()
    {
        ...
        if (i > 0)
        {
            ...
            if (!Minecraft.isRunningOnMac && getDefaultResourcePack() != null)
            {
                ...
                try
                {
                    inputstream = getDefaultResourcePack().getInputStream(new ResourceLocation("icons/icon_16x16.png"));
                    inputstream1 = getDefaultResourcePack().getInputStream(new ResourceLocation("icons/icon_32x32.png"));
