...
public class GuiIngame extends Gui
{
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        for (Score score1 : collection)
        {
            ...
            this.getFontRenderer().drawString(s2, l - this.getFontRenderer().getStringWidthInt(s2), k, 553648127);
            ...
            if (j == collection.size())
            {
                ...
                this.getFontRenderer().drawString(s3, l1 + i / 2 - this.getFontRenderer().getStringWidthInt(s3) / 2, k - this.getFontRenderer().FONT_HEIGHT, 553648127);
            }
        }
    }
